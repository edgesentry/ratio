...
| RB8 | Composition runtime | **Build** | — | Thin orchestrator | **v0** — [`crates/ratio-core`](../crates/ratio-core) `ratio derive`; ODS handoff stays in `poc/` | Oxigraph; point `poc` at the bindings |
