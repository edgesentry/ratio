...
| **4** | 参照 Pull 消費者 | **コアに含めない** | サンプル: `ratio-poc-pull`（[`samples/`](../samples/)）。本番アプリは外。Ratio 本体の責務外 |
...
| **参照 Pull クライアント（任意）** | Ratio チームまたはコミュニティが **別成果物**として | サンプル: `ratio-poc-pull`。Ratio コアに吸収しない |
