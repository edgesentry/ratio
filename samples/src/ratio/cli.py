...
SCENARIOS = {
    "K1": {
        "domain": "factory",
        "source_device": "did:example:factory-robot-01",
        "produced_by": "urn:ratio:node:factory-poc-01",
    ...
    "S1": {
        "domain": "maritime",
        "source_device": "did:example:vessel-engine-vib-01",
        "produced_by": "urn:ratio:node:maritime-poc-01",
